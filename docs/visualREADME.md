...
![JupyterHub Login Page](docs/images/01_jupyterhub_login_page.png)

### 2. User Session Loading
After authentication, the platform prepares your personalized environment.

![User Loading Screen](docs/images/02_user_loading.png)
...
![MinIO Login](docs/images/19_minio.png)

### 21. MinIO Dashboard
Browse and organize your stored data and model artifacts.

![MinIO Interface](docs/images/20_minio_after_login.png)

### 22. MinIO saved models
Browse saved models in MinIO.

![MinIO saved model](docs/images/21_minio_saved_model.png)

### 23. MinIO saved plots
Browse saved artifacts (plots) in MinIO.

![MinIO saved plots](docs/images/22_minio_saved_plot.png)
